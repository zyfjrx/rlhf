...
"""
    ...
    # 策略模型
    tokenizer = AutoTokenizer.from_pretrained('/Users/zhangyf/llm/Qwen2.5-0.5B')
    model = AutoModelForCausalLM.from_pretrained('/Users/zhangyf/llm/Qwen2.5-0.5B')
    # 奖励函数
    ...
    prompts_dataset = GSM8KDataset('/Users/zhangyf/PycharmProjects/rlhf/grpo_from_scratch/gsm8k_chinese', tokenizer)
